...
RidgePlot(tig.combined.nep,features = "dtd_FLD004",group.by = "age")+
  RidgePlot(tig.combined.nep,features = "dtd_FLD500",group.by = "age")+
  RidgePlot(tig.combined,features = "dtd_FLD004",group.by = "condition")

#aging related selected from knowledge
p1<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "ATF3",pt.size = 0.1,group.by = "age")
p2<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "FOS",pt.size = 0.1,group.by = "age")
p3<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "ADM",pt.size = 0.1,group.by = "age")
p4<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "CDKN1A",pt.size = 0.1,group.by = "age")
p5<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "DTYMK",pt.size = 0.1,group.by = "age")
p6<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "NCL",pt.size = 0.1,group.by = "age")
p7<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "PCLAF",pt.size = 0.1,group.by = "age")
p8<-FeatureScatter(tig.combined.nep,feature1 = "dtd_FLD500",feature2 = "DLGAP5",pt.size = 0.1,group.by = "age")

...
DimPlot(cancer_mcf10a.integrated,reduction="umap" ,group.by = "NEP")+
  DimPlot(cancer_mcf10a.integrated,reduction="umap" ,group.by = "run")+
  FeaturePlot(cancer_mcf10a.integrated, features = "dtd_FLD004",reduction = "umap", max.cutoff = 4)
...
cancer.integrated <- RunPCA(cancer.integrated, npcs=20, features = VariableFeatures(object = cancer_merge123456))
...
DimPlot(subset(cancer.integrated, subset=NEP=="75V", invert = TRUE),reduction = "umap",group.by = "celltype")+
  ...
  FeaturePlot(subset(cancer.integrated, subset=NEP=="75V", invert = TRUE), features = "dtd_FLD004",reduction = "umap", max.cutoff = 4)
